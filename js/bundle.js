!(function (t) {
  ...
  function (t, e, n) {
    ...
    (t.exports = function (t, e, n, a) {
      var u = !!a && !!a.unsafe,
        ...
        p = !!a && !!a.noTargetGet;
      "function" == typeof n &&
        ("string" != typeof e || i(n, "name") || o(n, "name", e), (f(n).source = l.join("string" == typeof e ? e : ""))),
        t !== r ? (u ? !p && t[e] && (s = !0) : delete t[e], s ? (t[e] = n) : o(t, e, n)) : s ? (t[e] = n) : c(e, n);
    ...
    (f || p || l) &&
      (s = function (t) {
        ...
        return (
          ...
          s
            ? r
              ? ((r.input = r.input.slice(h)), (r[0] = r[0].slice(h)), (r.index = c.lastIndex), (c.lastIndex += r[0].length))
              : (c.lastIndex = 0)
  ...
  function (t, e, n) {
    ...
    var r,
              ...
              try {
                l
                  ? (i || (2 === e.rejection && et(t, e), (e.rejection = 1)),
                    !0 === l ? (a = o) : (d && d.enter(), (a = l(o)), d && (d.exit(), (s = !0))),
                    a === f.promise ? v(G("Promise-chain cycle")) : (u = W(a)) ? u.call(a, p, v) : p(a))
                  : v(o);
              } catch (t) {
                d && !s && d.exit(), v(t);
              }
      ...
      Q = function (t, e, n) {
        var r, o;
        z
          ? (((r = U.createEvent("Event")).promise = e), (r.reason = n), r.initEvent(t, !1, !0), s.dispatchEvent(r))
  ...
  function (t, e, n) {
    ...
    (t.exports = function (t, e, n, f, l) {
      ...
      if (l) p = t;
        ...
        if (o(v)) {
          for (d = 0, h = i(t.length); h > d; d++) if ((y = f ? x(r((m = t[d]))[0], m[1]) : x(t[d])) && y instanceof s) return y;
          return new s(!1);
        }
        p = v.call(t);
      }
      for (g = p.next; !(m = g.call(p)).done; ) if ("object" == typeof (y = u(p, x, m.value, f)) && y && y instanceof s) return y;
      return new s(!1);
    }).stop = function (t) {
      return new s(!0, t);
    };
  ...
  function (t, e, n) {
    ...
    (d && h) ||
      ...
      "process" == u(y)
        ...
        : !c.addEventListener || "function" != typeof postMessage || c.importScripts || a(_) || "file:" === v.protocol
        ? (r =
    ...
    var r = n(33),
      ...
      s = function (t) {
        ...
        return function (v, d, h, y) {
          for (
            var g, m, x = i(v), w = o(x), b = r(d, h, 3), E = c(w.length), S = 0, _ = y || a, L = e ? _(v, E) : n ? _(v, 0) : void 0;
            E > S;
            S++
          )
  ...
  function (t, e, n) {
    var r = (function (t) {
      ...
      return (
        ...
        (t.mark = function (t) {
          return (
            Object.setPrototypeOf ? Object.setPrototypeOf(t, p) : ((t.__proto__ = p), c in t || (t[c] = "GeneratorFunction")),
    ...
    t.exports = function (t, e, n, f, v, m, x) {
      ...
      if (
        (T &&
          ...
          d !== Object.prototype &&
            w.next &&
            (l || i(w) === d || (c ? c(w, d) : "function" != typeof w[y] && u(w, y, g)), a(w, _, !0, !0), l && (p[_] = g))),
        "values" == v &&
          j &&
          "values" !== j.name &&
          ((L = !0),
        ...
        if (((b = {values: S("values"), keys: m ? A : S("keys"), entries: S("entries")}), x))
      ...
      return [
        ...
        function (t, r) {
          ...
          for (var S, _ = "", L = 0, O = 0; O < b.length; O++) {
            E = b[O];
            for (var j = String(E[0]), A = l(p(a(E.index), v.length), 0), T = [], P = 1; P < E.length; P++)
  ...
  function (t, e, n) {
      ...
      !(function (t, e) {
        ...
        function s() {
          var t = (function (t) {
            ...
            return {total: e, days: n, hours: Math.floor((e / 36e5) % 24), minutes: o, seconds: r};
          })(e);
          ...
          return regeneratorRuntime.wrap(function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  return (t.next = 2), fetch(e, {method: "POST", headers: {"Content-Type": "application/json"}, body: n});
                case 2:
    ...
    var d = function () {
      var t = (function () {
        function t(e, n, r, o, i, c) {
          ...
          (this.classes = u), (this.parent = document.querySelector(c)), (this.transfer = 1), this.changeToUAH();
        }
        var e, n, r;
        return (
          (e = t),
              ...
              value: function () {
                ...
                0 === this.classes.length
                  ...
                  (t.innerHTML = "\n                <img src="
                    ...
                    .concat(this.title, '</h3>\n                <div class="menu__item-descr">')
                    .concat(
                      this.descr,
                      '</div>\n                <div class="menu__item-divider"></div>\n                <div class="menu__item-price">\n                    <div class="menu__item-cost">Price:</div>\n                    <div class="menu__item-total"><span>'
                    )
                    .concat(this.price, "</span> USD/day</div>\n                </div>\n            ")),
      ...
      })("https://6348588d0b382d796c6fde8e.mockapi.io/food_cards").then(function (e) {
    ...
    var h = function () {
      ...
      function a(t, e) {
        document.querySelectorAll(t).forEach(function (t) {
          t.classList.remove(e),
            t.getAttribute("id") === localStorage.getItem("sex") && t.classList.add(e),
            t.getAttribute("data-ratio") === localStorage.getItem("ratio") && t.classList.add(e);
        });
      }
      function u(e, n) {
        ...
        r.forEach(function (e) {
          e.addEventListener("click", function (e) {
            e.target.getAttribute("data-ratio")
              ? ((o = +e.target.getAttribute("data-ratio")), localStorage.setItem("ratio", +e.target.getAttribute("data-ratio")))
              : ((t = e.target.getAttribute("id")), localStorage.setItem("sex", e.target.getAttribute("id"))),
              r.forEach(function (t) {
      ...
      localStorage.getItem("sex") ? (t = localStorage.getItem("sex")) : ((t = "female"), localStorage.setItem("sex", "female")),
        localStorage.getItem("ratio") ? (o = localStorage.getItem("ratio")) : ((o = 1.375), localStorage.setItem("ratio", 1.375)),
        c(),
    ...
    var y = function (t, e) {
      var n = document.querySelectorAll(t),
        ...
        c = "Thank you! We'll be in touch soon",
    ...
    var g = function (t) {
      ...
      l.length < 10
        ? ((h.textContent = "0".concat(l.length)), (y.textContent = "0".concat(f)))
